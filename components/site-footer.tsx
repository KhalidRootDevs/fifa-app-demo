      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <p className="text-center text-gray-400 max-w-2xl mx-auto text-sm">
            Dive into the thrilling world of live sports with FIFA 2026! Enjoy
            HD football streams, stay updated with fixtures and explore 100+
            leagues. Every match is a unique experience. Join us for an
            unmatched sports journey!
          </p>
        </div>
        ...
        <div className="text-center text-sm text-gray-400 mb-4">
          Email:{" "}
          <a
            href="mailto:support@holafootball.com"
        ...
        <div className="text-center text-xs text-gray-500">
          © 2023 Holafootball. All Rights Reserved.
        </div>
      </div>
    </footer>
  );
