    ...
    <footer className="mt-16 glass-effect pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-6">
              Experience the ultimate FIFA World Cup 2026 with live streaming,
              comprehensive coverage, and exclusive content from the greatest
              football tournament across North America.
            </p>
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Subscribe to get the latest World Cup 2026 news, match updates,
              and exclusive tournament content.
            </p>
        ...
        <div className="border-t border-white/10 pt-6 mt-6 text-center text-xs text-gray-500">
          © {new Date().getFullYear()} FIFA World Cup 2026. All Rights Reserved.
          | USA • Canada • Mexico
        </div>
      </div>
    </footer>
