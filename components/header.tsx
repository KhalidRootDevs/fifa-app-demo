...
import { Search, Menu, X, Bell, LogIn, UserPlus } from "lucide-react"
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <button
                ...
                className="text-gray-300 hover:text-white transition-colors text-sm font-medium flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-white/10"
                aria-label="Sign in"
              >
                <LogIn size={18} />
            ...
            >
              <nav className="flex flex-col space-y-1 px-4">
                ...
                <button
                  ...
                  className="gradient-bg text-white py-3 px-2 rounded-lg font-medium flex items-center gap-2"
                >
                  <UserPlus size={18} />
                  <span>Sign up</span>
                </button>
