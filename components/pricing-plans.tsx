...
import { Check, X, CreditCard, Bitcoin, Shield, Lock, Zap, Crown } from "lucide-react"
...
export function PricingPlans() {
  ...
  const plans = [
    {
      id: "basic",
      name: "Basic",
      description: "Perfect for casual football fans",
      price: 9.99,
      originalPrice: 14.99,
      icon: Zap,
      features: [
        { name: "HD quality streaming", included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Download for offline viewing", included: true },
      ],
  ...
  const handleCheckout = () => {
    ...
    if (selectedPlan && selectedPayment) {
      ...
      const checkoutUrl = `/checkout/${selectedPlan}?payment=${selectedPayment}`
  ...
  return (
    <div className="mb-20">
      ...
      {selectedPlan && user && selectedPayment && (
        <motion.div
                    ...
                    <div className="space-y-3">
                      ...
                      {selectedPaymentData?.discount && (
                        <div className="flex justify-between items-center text-green-400">
                          ...
                          <span>-${((selectedPlanData.price * selectedPaymentData.discount) / 100).toFixed(2)}</span>
                        </div>
                      )}
                      ...
                      <div className="border-t border-white/10 pt-3 mt-4">
                        <div className="flex justify-between items-center">
                          ...
                          <div className="text-right">
                            <div className="text-2xl font-bold text-green-400">${calculateFinalPrice().toFixed(2)}</div>
