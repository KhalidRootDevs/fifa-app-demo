...
import { ChevronLeft, ChevronRight, Star, Calendar, Clock, MapPin, Users, Play } from "lucide-react"
...
const featuredMatches = [
  {
    ...
    city: "New York",
    viewers: "2.1M",
    background: "/placeholder.svg?height=500&width=1200&text=Brazil+vs+Germany+World+Cup",
  },
  {
    id: 2,
    stage: "Group B",
    ...
    city: "Los Angeles",
    viewers: "1.8M",
    background: "/placeholder.svg?height=500&width=1200&text=Argentina+vs+Spain+World+Cup",
  },
  {
    id: 3,
    stage: "Group C",
    ...
    city: "Mexico City",
    viewers: "0",
    background: "/placeholder.svg?height=500&width=1200&text=France+vs+England+World+Cup",
  },
]
    ...
    >
      ...
      <div className="absolute top-4 left-4 z-10">
        <div className="flex items-center gap-2 bg-black/50 backdrop-blur-sm px-3 py-1.5 rounded-full">
          ...
          <span className="text-sm font-medium text-white">Featured World Cup Matches</span>
        </div>
      </div>
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6 z-10">
                <div className="flex items-center gap-2 mb-4">
                  <div className="px-2 py-1 bg-red-600/80 rounded text-xs font-medium">FIFA WORLD CUP 2026</div>
                    ...
                    {match.time === "LIVE" ? (
                      <>
                        ...
                        <div className="flex items-center gap-2 bg-red-500/20 px-3 py-1 rounded-full">
                          ...
                          <span className="text-red-500 font-medium text-sm">{match.minute}'</span>
                        </div>
                      </>
                    ) : (
                      <>
                        ...
                        <div className="flex items-center gap-2 bg-yellow-500/20 px-3 py-1 rounded-full">
                          ...
                          <span className="text-yellow-500 font-medium text-sm">{match.kickoff}</span>
                        </div>
                      </>
                    )}
                  </div>
