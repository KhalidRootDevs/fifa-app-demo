...
const mockMatchData = {
  ...
  homeScore: 2,
  awayScore: 1,
  description: "Classic rivalry match between Brazil and Argentina",
  streamSources: [
    {
      name: "ESPN",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-black dark:text-white">Edit Match</h1>
          <p className="text-gray-600 dark:text-gray-400">Update match details and stream sources</p>
        </div>
      </div>
